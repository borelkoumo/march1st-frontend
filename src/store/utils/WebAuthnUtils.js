...
exports.isBrowserCompatible = exports.isPlatformAuthenticatorAvailable = void 0;
var isBrowserCompatible = function () {
    return window.PublicKeyCredential ? true : false;
};
exports.isBrowserCompatible = isBrowserCompatible;
/**
 ...
 *
 */
var isPlatformAuthenticatorAvailable = function () {
    // If PublicKeyCredential interface is not available, return false
    if (!isBrowserCompatible()) {
        return false;
    }
    if (typeof PublicKeyCredential.isUserVerifyingPlatformAuthenticatorAvailable !==
        "function") {
